...
@Component({
  ...
  templateUrl: './blog-detail-left-sidebar.component.html',
  styleUrls: ['./blog-detail-left-sidebar.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class BlogDetailLeftSidebarComponent implements OnInit {
