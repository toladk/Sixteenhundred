...
@Component({
  selector: 'app-portfolio2columns',
  templateUrl: './portfolio2columns.component.html',
  styleUrls: ['./portfolio2columns.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class Portfolio2columnsComponent implements OnInit {
